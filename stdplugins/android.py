...
@borg(outgoing=True, pattern="^.magisk$")
...
@borg(outgoing=True, pattern=r"^.device(?: |$)(\S*)")
...
@borg(outgoing=True, pattern=r"^.codename(?: |)([\S]*)(?: |)([\s\S]*)")
...
@borg(outgoing=True, pattern=r"^.specs(?: |)([\S]*)(?: |)([\s\S]*)")
...
@borg(outgoing=True, pattern=r"^.twrp(?: |$)(\S*)")
